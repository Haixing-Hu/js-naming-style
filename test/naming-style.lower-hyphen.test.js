...
/**
 * Unit tests of the {@link NamingStyle.LOWER_HYPHEN}.
 *
 * @author Haixing Hu
 */
describe('Test the NamingStyle.LOWER_HYPHEN', () => {
  test('Test NamingStyle.LOWER_HYPHEN.to(), undefined', () => {
  ...
  test('Test NamingStyle.LOWER_HYPHEN.to(), null', () => {
  ...
  test('Test NamingStyle.LOWER_HYPHEN.to(), empty string', () => {
  ...
  test('Test NamingStyle.LOWER_HYPHEN.to(), simple case', () => {
  ...
  test('Test NamingStyle.LOWER_HYPHEN.to(), single word', () => {
