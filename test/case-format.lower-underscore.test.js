...
/**
 * Unit tests of the {@link CaseFormat.LOWER_UNDERSCORE}.
 *
 * @author Haixing Hu
 */
describe('Test the CaseFormat.LOWER_UNDERSCORE', () => {
  test('Test CaseFormat.LOWER_UNDERSCORE.to(), undefined', () => {
  ...
  test('Test CaseFormat.LOWER_UNDERSCORE.to(), null', () => {
  ...
  test('Test CaseFormat.LOWER_UNDERSCORE.to(), empty string', () => {
  ...
  test('Test CaseFormat.LOWER_UNDERSCORE.to(), simple case', () => {
  ...
  test('Test CaseFormat.LOWER_UNDERSCORE.to(), single word', () => {
